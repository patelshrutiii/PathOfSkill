...
section {
    ...
    background: linear-gradient(rgb(3 3 3 / 24%), rgb(75 74 74)), url(banner/w13.jpg);
...
<body onload="filterdata('filldata','view',1);">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4" style="border:0px solid;padding-left:80px;">
                <form method="post">
                    <input onkeyup="filterdata('searchdata','view',this.value);" type="text"
            ...
            <div class="col-md-8" style="border:0px solid;padding-left:250px;">
                <form>
                    <select class="sort-option" onChange="filterdata('level','view',this.value)"  style="cursor: pointer;float:right;">
            ...
            <div class="col-md-3" id="sidebar" style="border:0px solid;margin-top: -60px;">
                <div class="sidebar-box p-4">
                    ...
                    <form action="#" class="browse-form">
                        <label for="option-instructor-1" style="font-size:13px;"><input type="radio" onclick="filterdata('rate','view',4.5)"
                        ...
                        <label for="option-instructor-2" style="font-size:13px;"><input type="radio"  onclick="filterdata('rate','view',4.0)"
                        ...
                        <label for="option-instructor-3" style="font-size:13px;"><input type="radio"  onclick="filterdata('rate','view',3.5)"
                        ...
                        <label for="option-instructor-4" style="font-size:13px;"><input type="radio"  onclick="filterdata('rate','view',3.0)"
                ...
                <div class="sidebar-box  p-4">
                    ...
                    <form class="browse-form">
                        <?php
          $res=$con->query("select * from subcategory where categoryid='$_GET[cid]'");
          while($row1=mysqli_fetch_array($res))
          {     
          ?>
                        <label for="option-category-1"><input type="radio" onclick="filterdata('subcategory','view',<?php echo $row1[0];?>)"
                                name="category">&nbsp;<?php echo "$row1[2]";?></label><br>
                        <?php
                }
              ?>
                    </form>
                ...
                <div class="sidebar-box bg-white p-4">
                    ...
                    <form action="#" class="browse-form">
                        ...
                        <label for="option-course-type-1"><input type="radio" onclick="filterdata('clevel','view','beginner')" name="vehicle" value=""> Basic</label><br>
                        <label for="option-course-type-2"><input type="radio" onclick="filterdata('clevel','view','Intermediate')" id="option-course-type-2" name="vehicle"
                                value=""> Intermediate</label><br>
                        <label for="option-course-type-3"><input type="radio" onclick="filterdata('clevel','view','expert')" id="option-course-type-3" name="vehicle"
                ...
                <div class="sidebar-box bg-white p-4">
                    ...
                    <form action="#" class="browse-form">
                        <label for="option-software-1"><input type="radio" onclick="filterdata('price','view','paid')" name="price">&nbsp;Paid</label><br>

                        <label for="option-software-2"><input type="radio" onclick="filterdata('price','view','free')" name="price">&nbsp;Free</label><br>
