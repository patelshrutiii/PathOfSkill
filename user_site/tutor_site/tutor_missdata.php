...
.btndeleteall{
    ...
    width: 94px;
    color: white;
    background-color: rgb(4, 191, 181);
    box-shadow: rgb(0 0 0 / 10%) 12px 15px 20px;
   ...
   { 
       ?>
                ...
                <div class="row">
                    <!-- <div class="col-md-1"></div> -->
                    <?php
            $rt=$con->query("select ratetutor from rate_tutor where userid like '$indata[0]' and tutorid like '$_SESSION[tutor_id]'");
     ...
     while($indata=mysqli_fetch_array($in))
   {
    //    print_r($indata);
       ?>
            ...
            $rt=$con->query("select ratecourse from rate where userid like '$indata[0]' and tutorid like '$_SESSION[tutor_id]'");
            $rrt=mysqli_fetch_array($rt);
            ?>
                    <div class="col-md-12">
...
?>
        ...
        <?php
                  ...
                  $seldata=mysqli_fetch_array($sel);
                ?>
...
if($_SESSION['what']=="bank")
    {
       ...
       if($_REQUEST['task']=="delete")
        ...
        if($_REQUEST['task']=="deleteall")
        {
            $del=$con->query("delete from tutor_bankdetail");   
        }
        ...
        <div class="col-md-1">
            <form method="post">
                <!-- <button type="submit" class="button2" onclick="finddata('reportissue','deleteall',0);">Delete
                    All</button> -->
                    <button type="submit" class="btndeleteall" onclick="finddata('bank','deleteall',0);" style="vertical-align:middle"><span>Delete All</span></button>
    ...
    <div class="row">
        ...
        if($_REQUEST['task']=="update")
        {
            ...
            <center>
                ...
                <div>
                    <input type="text" class="courseselect1" name="txtifsc" placeholder="Enter IFSC code">
                </div>
                
                <div>
                    <input type="text" class="courseselect1" placeholder="Enter account number" name="txtano">
                </div>
